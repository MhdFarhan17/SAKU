    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="flex gap-2">
        ...
        <button 
          type="button" 
          onClick={onClose}
          className="px-4 h-10 rounded-[12px] border border-border text-text-muted font-bold text-sm hover:text-text-main hover:bg-surface-subtle transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer"
        >
